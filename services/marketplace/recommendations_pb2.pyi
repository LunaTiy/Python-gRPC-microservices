...
class _BookCategoryEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_BookCategory.ValueType], builtins.type):
    ...
    BOOK_CATEGORY_MYSTERY: _BookCategory.ValueType  # 0
    BOOK_CATEGORY_SCIENCE_FICTION: _BookCategory.ValueType  # 1
    BOOK_CATEGORY_SELF_HELP: _BookCategory.ValueType  # 2

class BookCategory(_BookCategory, metaclass=_BookCategoryEnumTypeWrapper): ...

BOOK_CATEGORY_MYSTERY: BookCategory.ValueType  # 0
BOOK_CATEGORY_SCIENCE_FICTION: BookCategory.ValueType  # 1
BOOK_CATEGORY_SELF_HELP: BookCategory.ValueType  # 2
...
class RecommendationRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["category", b"category", "max_results", b"max_results", "user_id", b"user_id"]) -> None: ...
